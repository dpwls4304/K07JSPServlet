...
응답헤더 설정하기
	...
	출력되지 않는다면 이는 캐시에 저장된 내용을 출려하고 있기 때문이다.
	아랫 설정은 캐시를 사용하지 않고 매번 새로고침(F5)한 것처럼
	새로운 정보로 갱신하겠다는 응답헤더 설정이다.
*/
//HTTP1.0에서 적용할 때 사용(현재는 사용하지 않지만 호환성을 위해 남겨둠)
...
response.addIntHeader("numberOfCrew", 99);//기존 헤더 덮어쓰기(수정) -> 99만출력
%>
<!DOCTYPE html>
<html>
<head>
