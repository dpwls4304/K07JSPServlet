...
<head>
<meta charset="UTF-8">
<title>cahtting01.jsp</title>
</head>
<body>
<!-- 
	프론트엔드 언어는 인터프리터 방식이라 첫줄 부터 차례대로 읽혀진다.
	따라서 현재 작성문에서 html과 script문의 위치를 바꾸면 실행되지 않는다.
	만약 script태그를 위에 올려서 실행시키고 싶다면 onload리스너로 실행시켜줘야한다.
 -->
