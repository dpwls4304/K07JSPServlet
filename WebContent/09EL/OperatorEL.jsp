...
<body>
	...
	하지만 EL에서는 null을 0으로 간주하여 곗나한다.
	따라서 NullPointerExceoption이 발생하지 않는다.
	*/
	...
	속성들만 사용하기 때문이다. JSTL도 마찬가지 동일한 특성을 가지고있다.
	*/
	...
	<!-- 
		...
		실제 서비스할 웹서버의 버전ㅇ르확인후 사용여부를 결정한다.
	...
	<!-- 
		EL에서는 정수와 정수를 연산한더라도 '실수'의 결과가
		나올 수 있다. 즉 자동현변환되어 출력된다.
