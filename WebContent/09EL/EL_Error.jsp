...
<body>
	<fieldset>
		...
		<ul>
			...
			<li>\${elArray.o } : \${elArray.o } [500에러]</li>
			<li>\${elCollection.0 } : \${elCollection.0 } [500에러]</li>
			<
		</ul>
		
		<h2>배열과 리스트계열 컬렉션 출력</h2>
		<!-- JSTL의 forEach태그를 통해 반복출력. 해당 문장은
		배여이나 컬렉션의 크기만큼 반복하는 확장 for문의 형태로 기술됨 -->
		<h4>배열</h4>
		...
		<%
		MemberDTO member = new MemberDTO("PARK", "1234", "박길동", null);
		%>
